...
var injectedNamesToPlugins$jscomp$inline_195 = {
  ...
  isOrderingDirty$jscomp$inline_196 = !1,
  pluginName$jscomp$inline_197;
for (pluginName$jscomp$inline_197 in injectedNamesToPlugins$jscomp$inline_195)
  if (
    injectedNamesToPlugins$jscomp$inline_195.hasOwnProperty(
      pluginName$jscomp$inline_197
    )
  ) {
    var pluginModule$jscomp$inline_198 =
      injectedNamesToPlugins$jscomp$inline_195[pluginName$jscomp$inline_197];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_197) ||
      namesToPlugins[pluginName$jscomp$inline_197] !==
        pluginModule$jscomp$inline_198
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_197])
        throw Error(
      ...
      isOrderingDirty$jscomp$inline_196 = !0;
    }
  }
isOrderingDirty$jscomp$inline_196 && recomputePluginOrdering();
