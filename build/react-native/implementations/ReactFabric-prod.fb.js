...
var injectedNamesToPlugins$jscomp$inline_189 = {
  ...
  isOrderingDirty$jscomp$inline_190 = !1,
  pluginName$jscomp$inline_191;
for (pluginName$jscomp$inline_191 in injectedNamesToPlugins$jscomp$inline_189)
  if (
    injectedNamesToPlugins$jscomp$inline_189.hasOwnProperty(
      pluginName$jscomp$inline_191
    )
  ) {
    var pluginModule$jscomp$inline_192 =
      injectedNamesToPlugins$jscomp$inline_189[pluginName$jscomp$inline_191];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_191) ||
      namesToPlugins[pluginName$jscomp$inline_191] !==
        pluginModule$jscomp$inline_192
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_191])
        throw Error(
      ...
      isOrderingDirty$jscomp$inline_190 = !0;
    }
  }
isOrderingDirty$jscomp$inline_190 && recomputePluginOrdering();
...
function commitHookEffectListMount(tag, finishedWork) {
  ...
  if (null !== finishedWork) {
    ...
    do {
      if ((effect.tag & tag) === tag) {
        var create$62 = effect.create;
        effect.destroy = create$62();
      }
      effect = effect.next;
    } while (effect !== finishedWork);
  }
    ...
    switch (exitStatus) {
      ...
      case 3:
        ...
        if (
          ...
          ((expirationTime = globalMostRecentFallbackTime + 500 - now()),
          10 < expirationTime)
        ) {
          if (
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$66 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$66.tag)) {
              var nextState = workInProgress$66.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$66.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$66.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$66.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (0 === (workInProgress$66.mode & 2)) {
                workInProgress$66.effectTag |= 64;
              ...
              workInProgress$66.effectTag |= 4096;
              workInProgress$66.expirationTime = thrownValue;
              break a;
            }
            workInProgress$66 = workInProgress$66.return;
          } while (null !== workInProgress$66);
          value = Error(
        ...
        workInProgress$66 = returnFiber;
        do {
          switch (workInProgress$66.tag) {
            case 3:
              wakeable = value;
              workInProgress$66.effectTag |= 4096;
              workInProgress$66.expirationTime = thrownValue;
              var update$67 = createRootErrorUpdate(
                workInProgress$66,
                wakeable,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$66, update$67);
              break a;
            case 1:
              wakeable = value;
              var ctor = workInProgress$66.type,
                instance = workInProgress$66.stateNode;
              if (
                0 === (workInProgress$66.effectTag & 64) &&
                ...
                workInProgress$66.effectTag |= 4096;
                workInProgress$66.expirationTime = thrownValue;
                var update$69 = createClassErrorUpdate(
                  workInProgress$66,
                  wakeable,
                  thrownValue
                );
                enqueueCapturedUpdate(workInProgress$66, update$69);
                break a;
              }
          }
          workInProgress$66 = workInProgress$66.return;
  ...
  if (null !== remainingExpirationTimeBeforeCommit) {
    ...
    do
      try {
        ...
        if (null === nextEffect) throw Error("Should be working on an effect.");
        captureCommitPhaseError(nextEffect, error$76);
        nextEffect = nextEffect.nextEffect;
      }
    while (null !== nextEffect);
