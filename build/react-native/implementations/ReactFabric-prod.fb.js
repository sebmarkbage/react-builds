...
var injectedNamesToPlugins$jscomp$inline_207 = {
  ...
  isOrderingDirty$jscomp$inline_208 = !1,
  pluginName$jscomp$inline_209;
for (pluginName$jscomp$inline_209 in injectedNamesToPlugins$jscomp$inline_207)
  if (
    injectedNamesToPlugins$jscomp$inline_207.hasOwnProperty(
      pluginName$jscomp$inline_209
    )
  ) {
    var pluginModule$jscomp$inline_210 =
      injectedNamesToPlugins$jscomp$inline_207[pluginName$jscomp$inline_209];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_209) ||
      namesToPlugins[pluginName$jscomp$inline_209] !==
        pluginModule$jscomp$inline_210
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_209])
        throw Error(
      ...
      isOrderingDirty$jscomp$inline_208 = !0;
    }
  }
isOrderingDirty$jscomp$inline_208 && recomputePluginOrdering();
...
function flushPassiveEffectsImpl() {
  ...
  for (var i = 0; i < unmountEffects.length; i += 2) {
    var effect$82 = unmountEffects[i],
      fiber = unmountEffects[i + 1],
      destroy = effect$82.destroy;
    effect$82.destroy = void 0;
  ...
  for (i = 0; i < unmountEffects.length; i += 2) {
    effect$82 = unmountEffects[i];
    fiber = unmountEffects[i + 1];
    try {
      var create$86 = effect$82.create;
      effect$82.destroy = create$86();
    } catch (error$87) {
      if (null === fiber) throw Error("Should be working on an effect.");
      captureCommitPhaseError(fiber, error$87);
    }
  }
  for (root = root.current.firstEffect; null !== root; )
    (create$86 = root.nextEffect),
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_796 = {
...
var internals$jscomp$inline_974 = {
  bundleType: devToolsConfig$jscomp$inline_796.bundleType,
  version: devToolsConfig$jscomp$inline_796.version,
  rendererPackageName: devToolsConfig$jscomp$inline_796.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_796.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_796.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_975 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_975.isDisabled &&
    hook$jscomp$inline_975.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_975.inject(internals$jscomp$inline_974)),
        (injectedHook = hook$jscomp$inline_975);
    } catch (err) {}
}
