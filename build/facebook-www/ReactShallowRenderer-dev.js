...
var Updater =
  ...
  (function() {
    ...
    _proto._enqueueCallback = function _enqueueCallback(
      callback,
      publicInstance
    ) {
    ...
    _proto.enqueueForceUpdate = function enqueueForceUpdate(
      publicInstance,
      callback,
      callerName
    ) {
    ...
    _proto.enqueueReplaceState = function enqueueReplaceState(
      publicInstance,
      completeState,
      callback,
      callerName
    ...
    _proto.enqueueSetState = function enqueueSetState(
      publicInstance,
      partialState,
      callback,
      callerName
      ...
      this._renderer._newState = Object.assign(
        {},
        currentState,
        {},
        partialState
...
var ReactShallowRenderer =
  ...
  (function() {
    ...
    _proto2._mountClassComponent = function _mountClassComponent(
      elementType,
      element,
      context
    ) {
    ...
    _proto2._updateClassComponent = function _updateClassComponent(
      elementType,
      element,
      context
    ) {
