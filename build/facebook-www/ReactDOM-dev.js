...
var _require = require("ReactFeatureFlags"),
  ...
  warnAboutSpreadingKeyToJSX = _require.warnAboutSpreadingKeyToJSX; // On WWW, false is used for a new modern build.
...

{
  topLevelUpdateWarnings = function(container) {
    ...
    var hasNonRootReactChild = !!(rootEl && getInstanceFromNode$2(rootEl));
...
function unmountComponentAtNode(container) {
  ...
  if (container._reactRootContainer) {
    {
      var rootEl = getReactRootElementInContainer(container);
      var renderedByDifferentReact = rootEl && !getInstanceFromNode$2(rootEl);
  ...
  } else {
    {
      ...
      var hasNonRootReactChild = !!(_rootEl && getInstanceFromNode$2(_rootEl)); // Check if the container itself is a React root node.
