...
function createInstance(
...

  {
    if (props.DEPRECATED_flareListeners != null) {
      ...
      // instance props.
      var DEPRECATED_flareListeners = props.DEPRECATED_flareListeners,
        otherProps = _objectWithoutPropertiesLoose(props, [
          "DEPRECATED_flareListeners"
        ]); // eslint-disable-line
...
function resetWorkInProgressVersions() {
  {
    for (var _i = 0; _i < workInProgressSecondarySources.length; _i++) {
      var _mutableSource = workInProgressSecondarySources[_i];
      _mutableSource._workInProgressVersionSecondary = null;
    }
...
var isSchedulerMocked =
  typeof Scheduler$1.unstable_flushAllWithoutAsserting === "function";

var flushWork =
  Scheduler$1.unstable_flushAllWithoutAsserting ||
  function() {
...
var validWrapperTypes = new Set([
  ...
  MemoComponent,
  SimpleMemoComponent,
  Block, // Normally skipped, but used when there's more than one root child.
  HostRoot
]);
