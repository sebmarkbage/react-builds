...
function addTrappedEventListener(
  ...
  var listenerWrapper = eventPriorities.get(topLevelType);
  ...
  capture
    ? targetContainer.addEventListener(topLevelType, eventSystemFlags, !0)
    : targetContainer.addEventListener(topLevelType, eventSystemFlags, !1);
  return eventSystemFlags;
}
...
for (
  var i$jscomp$inline_275 = 0;
  i$jscomp$inline_275 < otherDiscreteEvents.length;
  i$jscomp$inline_275++
)
  eventPriorities.set(otherDiscreteEvents[i$jscomp$inline_275], 0);
...
canUseDOM && isEventSupported("input");
...
var COMPONENT_TYPE = 0,
  ...
  TEXT_TYPE = 4;
if ("function" === typeof Symbol && Symbol.for) {
  var symbolFor$115 = Symbol.for;
  COMPONENT_TYPE = symbolFor$115("selector.component");
  HAS_PSEUDO_CLASS_TYPE = symbolFor$115("selector.has_pseudo_class");
  ROLE_TYPE = symbolFor$115("selector.role");
  TEST_NAME_TYPE = symbolFor$115("selector.test_id");
  TEXT_TYPE = symbolFor$115("selector.text");
}
...
function selectorToString(selector) {
  switch (selector.$$typeof) {
    case COMPONENT_TYPE:
      return "<" + (getComponentName(selector.value) || "Unknown") + ">";
    case HAS_PSEUDO_CLASS_TYPE:
      ...
      case 4:
        ...
        1073741823 !== workInProgressRootLatestSuspenseTimeout
          ...
          : ((exitStatus =
            ...
            (expirationTime =
              10 * (1073741821 - expirationTime) - prevExecutionContext),
      ...
      a: {
        ...
        if (
          ...
          var hasInvisibleParentBoundary =
              0 !== (suspenseStackCursor.current & 1),
            workInProgress$101 = returnFiber;
          do {
            var JSCompiler_temp;
            if ((JSCompiler_temp = 13 === workInProgress$101.tag)) {
              var nextState = workInProgress$101.memoizedState;
              if (null !== nextState)
                JSCompiler_temp = null !== nextState.dehydrated ? !0 : !1;
              else {
                var props = workInProgress$101.memoizedProps;
                JSCompiler_temp =
            ...
            if (JSCompiler_temp) {
              var wakeables = workInProgress$101.updateQueue;
              if (null === wakeables) {
                var updateQueue = new Set();
                updateQueue.add(wakeable);
                workInProgress$101.updateQueue = updateQueue;
              } else wakeables.add(wakeable);
              if (0 === (workInProgress$101.mode & 2)) {
                workInProgress$101.effectTag |= 64;
              ...
              workInProgress$101.effectTag |= 4096;
              workInProgress$101.expirationTime = thrownValue;
              break a;
            }
            workInProgress$101 = workInProgress$101.return;
          } while (null !== workInProgress$101);
          value = Error(
        ...
        workInProgress$101 = returnFiber;
        do {
          switch (workInProgress$101.tag) {
            case 3:
              wakeable = value;
              workInProgress$101.effectTag |= 4096;
              workInProgress$101.expirationTime = thrownValue;
              var update$102 = createRootErrorUpdate(
                workInProgress$101,
                wakeable,
                thrownValue
              );
              enqueueCapturedUpdate(workInProgress$101, update$102);
              break a;
            case 1:
              wakeable = value;
              var ctor = workInProgress$101.type,
                instance = workInProgress$101.stateNode;
              if (
                0 === (workInProgress$101.effectTag & 64) &&
                ...
                enqueueCapturedUpdate(workInProgress$101, update$104);
                break a;
              }
          }
          workInProgress$101 = workInProgress$101.return;
  ...
  if (null !== remainingExpirationTimeBeforeCommit) {
    ...
    do
      try {
        ...
        if (null === nextEffect) throw Error(formatProdErrorMessage(330));
        captureCommitPhaseError(nextEffect, error$124);
        nextEffect = nextEffect.nextEffect;
      }
    while (null !== nextEffect);
    nextEffect = null;
...
function flushPassiveEffectsImpl() {
  ...
  for (var i = 0; i < unmountEffects.length; i += 2) {
    var effect$129 = unmountEffects[i],
      fiber = unmountEffects[i + 1],
      destroy = effect$129.destroy;
    effect$129.destroy = void 0;
  ...
  for (i = 0; i < unmountEffects.length; i += 2) {
    effect$129 = unmountEffects[i];
    fiber = unmountEffects[i + 1];
    try {
      var create = effect$129.create;
      effect$129.destroy = create();
    } catch (error$133) {
      if (null === fiber) throw Error(formatProdErrorMessage(330));
      captureCommitPhaseError(fiber, error$133);
    }
  }
  for (root = root.current.firstEffect; null !== root; )
    (create = root.nextEffect),
...
attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$135 = fiber.stateNode;
      root$135.hydrate &&
        (markRootExpiredAtTime(root$135, root$135.firstPendingTime),
        ensureRootIsScheduled(root$135),
    ...
    case 13:
      flushSync(function() {
        ...
        (root$135 = computeExpirationBucket(
          requestCurrentTimeForUpdate(),
          150,
          100
        )),
        markRetryTimeIfNotHydrated(fiber, root$135);
  }
};
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1251 = {
...
var internals$jscomp$inline_1629 = {
  bundleType: devToolsConfig$jscomp$inline_1251.bundleType,
  version: devToolsConfig$jscomp$inline_1251.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1251.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1251.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1251.findFiberByHostInstance ||
...
exports.createHasPsuedoClassSelector = function(selectors) {
...
exports.unstable_createEventHandle = function() {
  return null;
};
