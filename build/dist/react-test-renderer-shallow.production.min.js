...
this._renderer._context)};c.enqueueSetState=function(b,d,a,c){this._enqueueCallback(a,b);a=this._renderer._newState||b.state;"function"===typeof d&&(d=d.call(b,a,b.props));null!==d&&void 0!==d&&(this._renderer._newState=w({},a,{},d),this._renderer.render(this._renderer._element,this._renderer._context))};return a}(),y=function(){function a(){this._reset()}var c=a.prototype;c._reset=function(){this._rendered=this._newState=this._instance=this._element=this._context=null;this._forcedUpdate=this._rendering=
...
d=void 0!==d?d:null;if(null!==b._workInProgressHook&&null!==b._workInProgressHook.memoizedState){var c=b._workInProgressHook.memoizedState,f=c[1];if(null!==d){a:if(null===f)f=!1;else{for(var g=0;g<f.length&&g<d.length;g++)if(!v(d[g],f[g])){f=!1;break a}f=!0}if(f)return c[0]}}a=a();b._workInProgressHook.memoizedState=[a,d];return a},useReducer:a,useRef:function(a){b._validateCurrentlyRenderingComponent();b._createWorkInProgressHook();var d=b._workInProgressHook.memoizedState;return null===d?(a={current:a},
...
b;if("function"===typeof a.getDerivedStateFromProps){var h=a.getDerivedStateFromProps.call(null,c,f);null!=h&&(f=w({},f,h))}h=!0;this._forcedUpdate?(h=!0,this._forcedUpdate=!1):"function"===typeof this._instance.shouldComponentUpdate?h=!!this._instance.shouldComponentUpdate(c,f,e):a.prototype&&a.prototype.isPureReactComponent&&(h=!u(d,c)||!u(b,f));h&&"function"!==typeof a.getDerivedStateFromProps&&"function"!==typeof this._instance.getSnapshotBeforeUpdate&&("function"===typeof this._instance.componentWillUpdate&&
this._instance.componentWillUpdate(c,f,e),"function"===typeof this._instance.UNSAFE_componentWillUpdate&&this._instance.UNSAFE_componentWillUpdate(c,f,e));this._instance.context=e;this._instance.props=c;this._instance.state=f;this._newState=null;h&&(this._rendered=this._instance.render())};return a}();y.createRenderer=function(){return new y};return y});
