...
function t(a){var b=a.type,c=a.props;if("function"===typeof b)return b(c);if("string"===typeof b)return k.renderToStaticMarkup(a);throw Error("Unsupported type.");}function r(a,b){var c={id:a.nextChunkId++,model:b,ping:function(){var b=a.pingedSegments;b.push(c);1===b.length&&u(a)}};return c}
...
function u(a){var b=a.pingedSegments;a.pingedSegments=[];for(var c=0;c<b.length;c++){var d=void 0,e=a,f=b[c],g=f.model;try{for(;"object"===typeof g&&null!==g&&g.$$typeof===m;){var v=g;f.model=v;g=t(v)}var w=n(g,e.toJSON),x=f.id;d=0===x?w+"\n":"J"+x.toString(16)+":"+w+"\n";e.completedJSONChunks.push(l.encode(d))}catch(h){"object"===typeof h&&null!==h&&"function"===typeof h.then?(d=f.ping,h.then(d,d)):y(e,f.id,h)}}a.flowing&&z(a)}var A=!1;
...
var B={__proto__:null,"default":{renderToReadableStream:function(a){var b;return new ReadableStream({start:function(c){c=b=p(a,c);c.flowing=!0;u(c)},pull:function(){var a=b;a.flowing=!0;z(a)},cancel:function(){}})}}},C=B&&B["default"]||B;module.exports=C.default||C;
