...
function createReactNoop(reconciler, useMutation) {
  ...
  var sharedHostConfig = {
    ...
    DEPRECATED_mountResponderInstance: function () {// NO-OP
    },
    DEPRECATED_unmountResponderInstance: function () {// NO-OP
    },
    ...
    beforeRemoveInstance: function (instance) {// NO-OP
    }
  };
  ...
  var ReactNoop = {
    ...
    createBlockingRoot: function () {
      ...
      var fiberRoot = NoopRenderer.createContainer(container, BlockingRoot, false, null);
      return {
        _Scheduler: Scheduler,
        render: function (children) {
          NoopRenderer.updateContainer(children, fiberRoot, null, null);
    ...
    dumpTree: function () {
      ...
      function logUpdateQueue(updateQueue, depth) {
        ...
        var last = updateQueue.baseQueue;
...
var _createReactNoop = createReactNoop(ReactFiberPersistentReconciler, // reconciler
false // useMutation
),
    ...
    createPortal$1 = _createReactNoop.createPortal,
