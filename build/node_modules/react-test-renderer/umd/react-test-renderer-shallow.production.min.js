...
n){do h=b(h,n.action),n=n.next;while(null!==n);a.first=null;g.memoizedState=h}return[h,d]}b=b===L?"function"===typeof d?d():d:void 0!==a?a(d):d;g.memoizedState=b;b=g.queue={first:null,dispatch:null};b=b.dispatch=c._dispatchAction.bind(c,b);return[g.memoizedState,b]},a=function(){c._validateCurrentlyRenderingComponent()};return{readContext:function(c,b){return c._currentValue},useCallback:function(c){return c},useContext:function(b){c._validateCurrentlyRenderingComponent();return b._currentValue},
...
useRef:function(b){c._validateCurrentlyRenderingComponent();c._createWorkInProgressHook();var a=c._workInProgressHook.memoizedState;return null===a?(b={current:b},c._workInProgressHook.memoizedState=b):a},useState:function(c){return b(L,c)},useResponder:function(c,b){return{props:b,responder:c}},useTransition:function(b){c._validateCurrentlyRenderingComponent();return[function(c){c()},!1]},useDeferredValue:function(b,a){c._validateCurrentlyRenderingComponent();return b}}};a._dispatchAction=function(c,
