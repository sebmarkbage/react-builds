...
var removeInstanceEventHandles = $$$hostConfig.removeInstanceEventHandles;
...
var removeScopeEventHandles = $$$hostConfig.removeScopeEventHandles;
          ...
          {
            {
              var payload = newChild._payload;
              var init = newChild._init;
              return updateSlot(returnFiber, oldFiber, init(payload), expirationTime);
            }
          }
      }
        ...
        case REACT_LAZY_TYPE:
          {
            var payload = newChild._payload;
            var init = newChild._init;
            return updateFromMap(existingChildren, returnFiber, newIdx, init(payload), expirationTime);
          }
        ...
        case REACT_LAZY_TYPE:
          {
            ...
            return reconcileChildFibers(returnFiber, currentFirstChild, init(payload), expirationTime);
          }
...
function markUpdateTimeFromFiberToRoot(fiber, expirationTime) {
  ...
  {
    if (alternate === null && (fiber.effectTag & (Placement | Hydrating)) !== NoEffect) {
  ...
  if (node === null && fiber.tag === HostRoot) {
    ...
    while (node !== null) {
      ...
      {
        if (alternate === null && (node.effectTag & (Placement | Hydrating)) !== NoEffect) {
          warnAboutUpdateOnNotYetMountedFiberInDEV(fiber);
        }
      }
