...
c){k=!0;c=d;e=f;break}if(g===e){k=!0;e=d;c=f;break}g=g.sibling}if(!k)throw Error(h(189));}}if(c.alternate!==e)throw Error(h(190));}if(3!==c.tag)throw Error(h(188));return c.stateNode.current===c?b:a}function p(b){var a=b.memoizedState;return 13===b.tag&&null!==a&&null===a.dehydrated}function q(b,a){for(var c=b.alternate;null!==a;){if(a===b||a===c)return!0;a=a.return}return!1}exports.findCurrentFiberUsingSlowPath=n;
...
exports.getSuspenseInstanceFromFiber=function(b){if(13===b.tag){var a=b.memoizedState;null===a&&(b=b.alternate,null!==b&&(a=b.memoizedState));if(null!==a)return a.dehydrated}return null};exports.isFiberHiddenOrDeletedAndContains=function(b,a){var c;(c=0!==(b.effectTag&8)&&q(b,a))||(c=b.child,c=p(b)&&null!==c&&q(c,a));return c};exports.isFiberMounted=function(b){return l(b)===b};exports.isFiberSuspenseAndTimedOut=p;exports.isMounted=function(b){return(b=b._reactInternals)?l(b)===b:!1};
