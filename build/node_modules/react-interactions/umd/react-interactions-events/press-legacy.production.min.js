...
isActivePressStart:!1,isPressed:!1,isPressWithinResponderRegion:!0,pointerType:"",pressTarget:null,responderRegionOnActivation:null,responderRegionOnDeactivation:null,ignoreEmulatedMouseEvents:!1,activePointerId:null,shouldPreventClick:!1,touchEvent:null}},onEvent:function(b,c,d,a){var f=b.pointerType,g=b.type;if(d.disabled)v(c,a),t(b,c,d,a),a.ignoreEmulatedMouseEvents=!1;else{var e=b.nativeEvent,h=a.isPressed;switch(g){case "pointerdown":case "keydown":case "mousedown":case "touchstart":if(h)b=e.key,
!y(e)||" "!==b&&"Spacebar"!==b||e.preventDefault();else{var k="touchstart"===g,l="pointerdown"===g,p="keyboard"===f;h="mouse"===f;if("mousedown"!==g||!a.ignoreEmulatedMouseEvents){a.shouldPreventClick=!1;if(k)a.ignoreEmulatedMouseEvents=!0;else if(p)if(y(e)){g=e.altKey;p=e.ctrlKey;var q=e.metaKey,m=e.shiftKey;!1===d.preventDefault||m||q||p||g||(g=e.key," "!==g&&"Spacebar"!==g||e.preventDefault(),a.shouldPreventClick=!0)}else break;a.pointerType=f;f=a.pressTarget=c.getResponderNode();if(l)a.activePointerId=
e.pointerId;else if(k){k=e.targetTouches;k=0<k.length?k[0]:null;if(null===k)break;a.touchEvent=k;a.activePointerId=k.identifier}2===e.buttons||4<e.buttons||I&&h&&e.ctrlKey||(null!==f&&9!==f.nodeType&&(a.responderRegionOnActivation=A(c,f,d)),a.responderRegionOnDeactivation=null,a.isPressWithinResponderRegion=!0,a.buttons=e.buttons,1===e.button&&(a.buttons=4),z(b,c,d,a),a.addedRootEvents||(a.addedRootEvents=!0,c.addRootEventTypes(B)))}}break;case "click":a.shouldPreventClick&&e.preventDefault();h=d.onPress;
if(f=r(h))f=0===e.mozInputSource&&e.isTrusted?!0:0===e.detail&&0===e.screenX&&0===e.screenY&&0===e.clientX&&0===e.clientY;f&&(a.pointerType="keyboard",a.pressTarget=c.getResponderNode(),!1!==d.preventDefault&&e.preventDefault(),w(b,h,c,a,"press",0))}}},onRootEvent:function(b,c,d,a){var f=b.pointerType,g=b.type,e=b.target,h=b.nativeEvent,k=a.isPressed,l=a.activePointerId,p=a.pointerType;switch(g){case "pointermove":case "mousemove":case "touchmove":if(p!==f)break;if("pointermove"===g&&l!==h.pointerId)break;
else if("touchmove"===g){var q=C(h,l);if(null===q)break;a.touchEvent=q}var m=a.pressTarget;null!==m&&null!==m&&9!==m.nodeType&&("mouse"===f&&c.isTargetWithinNode(e,m)?a.isPressWithinResponderRegion=!0:D(q||h,c,d,a));a.isPressWithinResponderRegion?k?(d=d.onPressMove,r(d)&&w(b,d,c,a,"pressmove",1)):z(b,c,d,a):t(b,c,d,a);break;case "pointerup":case "keyup":case "mouseup":case "touchend":if(k){if(k=a.buttons,q=!1,"pointerup"!==g||l===h.pointerId){if("touchend"===g){m=C(h,l);if(null===m)break;e=a.touchEvent=
m;e=c.getActiveDocument().elementFromPoint(e.clientX,e.clientY)}else if("keyup"===g){if(!y(h))break;q=!0;v(c,a)}else 4===k&&v(c,a);if(null!==e&&c.isTargetWithinResponder(e)&&c.isTargetWithinHostComponent(e,"a")){g=h.altKey;l=h.ctrlKey;p=h.metaKey;var n=h.shiftKey;!1===d.preventDefault||n||p||l||g||(a.shouldPreventClick=!0)}g=a.pressTarget;t(b,c,d,a);l=d.onPress;null!==g&&r(l)&&(q||null===g||null===e||null===g||9===g.nodeType||("mouse"===f&&c.isTargetWithinNode(e,g)?a.isPressWithinResponderRegion=
!0:D(m||h,c,d,a)),a.isPressWithinResponderRegion&&4!==k&&w(b,l,c,a,"press",0));a.touchEvent=null}}else"mouseup"===g&&(a.ignoreEmulatedMouseEvents=!1);break;case "click":"keyboard"!==p&&v(c,a);break;case "scroll":if("mouse"===p)break;f=a.pressTarget;h=h.target;e=c.getActiveDocument();null===f||h!==e&&!c.isTargetWithinNode(f,h)||x(b,c,d,a);break;case "pointercancel":case "touchcancel":case "dragstart":x(b,c,d,a);break;case "blur":k&&e===a.pressTarget&&x(b,c,d,a)}},onUnmount:function(b,c,d){d.isPressed&&
(v(b,d),t(null,b,c,d))}});n.PressResponder=F;n.usePress=function(b){return u.DEPRECATED_useResponder(F,b)}});
