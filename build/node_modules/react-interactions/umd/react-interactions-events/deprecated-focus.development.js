 ...
 * react-interactions-events/deprecated-focus.development.js
 *
...
(function (global, factory) {
  ...
  var targetEventTypes = ['focus', 'blur', 'beforeblur'].concat(focusVisibleEvents);
  ...
  function dispatchFocusEvents(context, props, state) {
    ...
    if (isFunction(onFocus)) {
      var syntheticEvent = createFocusEvent(context, 'focus', target, pointerType, null);
  ...
  function dispatchBlurEvents(context, props, state) {
    ...
    if (isFunction(onBlur)) {
      var syntheticEvent = createFocusEvent(context, 'blur', target, pointerType, null);
  ...
  function dispatchFocusWithinEvents(context, event, props, state) {
    ...
    if (isFunction(onFocusWithin)) {
      var syntheticEvent = createFocusEvent(context, 'focuswithin', target, pointerType, null);
  ...
  function dispatchBlurWithinEvents(context, event, props, state) {
    ...
    if (isFunction(onBlurWithin)) {
      var syntheticEvent = createFocusEvent(context, 'blurwithin', target, pointerType, null);
  ...
  function dispatchAfterBlurWithinEvents(context, event, props, state) {
    ...
    if (isFunction(onAfterBlurWithin) && relatedTarget !== null) {
      var syntheticEvent = createFocusEvent(context, 'afterblurwithin', relatedTarget, pointerType, relatedTarget);
        ...
        case 'beforeblur':
          {
            ...
            if (isFunction(onBeforeBlurWithin)) {
              var syntheticEvent = createFocusEvent(context, 'beforeblurwithin', event.target, state.pointerType, null);
