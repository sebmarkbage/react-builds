...
a,J(c,d,b,a))})}},onRootEvent:function(a,c,d,b){if("blur"===a.type){var e=b.detachedTarget;null!==e&&e===a.target&&(G(c,a,d,b),b.detachedTarget=null,b.addedRootEvents&&(b.addedRootEvents=!1,c.removeRootEventTypes(u)))}},onUnmount:function(a,c,d){d.isFocused&&I(a,c,d,!1)}});exports.FocusResponder=H;exports.FocusWithinResponder=K;exports.useFocus=function(a){return g.DEPRECATED_useResponder(H,a)};exports.useFocusWithin=function(a){return g.DEPRECATED_useResponder(K,a)};
