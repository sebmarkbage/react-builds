            ...
            try {
              for (var _iterator8 = reactHooks[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                ...
                if (isDirectlyInsideComponentOrHook) {
                  ...
                  var _message2 = "React Hook \"" + context.getSource(hook) + "\" is called in " + ("function \"" + context.getSource(codePathFunctionName) + "\" ") + 'that is neither a React function component nor a custom ' + 'React Hook function.';
...
var ExhaustiveDeps = {
  ...
  create: function (context) {
    ...
    function visitCallExpression(node) {
      ...
      switch (callback.type) {
        ...
        case 'ArrowFunctionExpression':
          visitFunctionWithDependencies(callback, declaredDependenciesNode, reactiveHook);
          return;
        // Handled
        ...
        case 'Identifier':
          ...
          switch (def.node.type) {
            case 'FunctionDeclaration':
              // useEffect(() => { ... }, []);
              visitFunctionWithDependencies(def.node, declaredDependenciesNode, reactiveHook);
              return;
            // Handled
            ...
            case 'VariableDeclarator':
              ...
              switch (init.type) {
                ...
                case 'FunctionExpression':
                  ...
                  visitFunctionWithDependencies(init, declaredDependenciesNode, reactiveHook);
                  return;
                // Handled
              }
    ...
    function visitFunctionWithDependencies(node, declaredDependenciesNode, reactiveHook) {
      var reactiveHookName = getNodeWithoutReactNamespace(reactiveHook).name;
